...
\email{me@paulgossman.com}                         % optional, remove / comment the line if not wanted
...
\section{Experience}
\cventry{May 2020 -- August 2020}{Quantitative Trader Intern (incoming)}{Jane Street Capital}{New York, NY}{}{%
}
\cventry{September 2019 -- December 2019}{Software Engineer Intern}{Jane Street Capital}{New York, NY}{}{%
    \begin{itemize}%
        \item Collaborated with traders and developers to create software tooling for options desk.
        \item Created new tool for in-house version control system for improving developer workflow.
    \end{itemize}
}
...
\section{Technical Skills}
    \cvlistitem{C++, Python, OCaml, Linux, testing \& TDD, async programming, Git \& Mercurial}
